"""Service for handling PDF ingestion requests from the API."""
...
class PDFUploadService:
    """Service for managing PDF uploads and ingestion."""
    ...
    def upload_and_ingest(file_content: bytes, filename: str,
        ...
        """Process uploaded PDF and ingest into ChromaDB.
        ...
        print(f"\n🎯 Processing PDF upload: {filename}")
